...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./progress.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./progress.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dashboard = (_dec = (0, _connect2.default)('dashboard_update', initialState), _dec(_class = function (_React$Component) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Steps(props) {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_step2.default, { data: props.source }),
	    props.functions.map(function (item) {
	      return _react2.default.createElement(_step2.default, { data: item });
	    })
	  );
	}
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Step(props) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: _step2.default.lockedStep },
	    _react2.default.createElement(
	      'div',
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: _step2.default.actions },
	      _react2.default.createElement(
	        'a',
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./step.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./step.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".step__actions___EPrWV {\n  position: absolute;\n  top: 0;\n  right: 0;\n}\n\n.step__lockedStep___2cZQy {\n  position: relative;\n  border-top: 1px solid #efefef;\n}\n\n.step__label___sPGhH {\n  padding: 4px 0;\n  margin-right: 123px;\n  overflow: hidden;\n  word-wrap: break-word;\n  text-overflow: ellipsis;\n}\n\n.step__captureButton___1Tpnn {\n  font-family: 'twola';\n  font-style: normal;\n  font-weight: normal;\n  line-height: 1;\n  -webkit-font-smoothing: antialiased;\n  position: relative;\n  display: inline-block;\n  overflow: hidden;\n  color: #00a2de;\n  margin: 0 4px;\n  vertical-align: middle;\n  cursor: pointer;\n  font-size: 14px;\n  border: 1px solid #00a2de;\n  height: 24px;\n  width: 24px;\n  padding: 3px 0 0;\n  text-align: center;\n  border-radius: 100%;\n}\n\n.step__captureButton___1Tpnn::before {\n  content: \"S\";\n}\n", ""]);

	// exports
	exports.locals = {
		"actions": "step__actions___EPrWV",
		"lockedStep": "step__lockedStep___2cZQy",
		"label": "step__label___sPGhH",
		"captureButton": "step__captureButton___1Tpnn"
	};
